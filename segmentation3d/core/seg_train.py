...
import time
import torch
# torch.cuda.set_per_process_memory_fraction(0.5, None)
import torch.nn as nn
import torch.optim as optim
from torch.utils.data import DataLoader
from tensorboardX import SummaryWriter

from ..dataloader.dataset import SegmentationDataset
from ..dataloader.sampler import EpochConcateSampler
from ..loss.focal_loss import FocalLoss
from ..loss.multi_dice_loss import MultiDiceLoss
...
def train(train_config_file):
    ...
    dataset = SegmentationDataset(
                ...
                crop_normalizers=[AdaptiveNormalizer()])
    ...
    net_module = importlib.import_module('skullengine.segmentation3d.network.' + train_cfg.net.name)
